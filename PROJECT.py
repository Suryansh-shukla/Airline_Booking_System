...
root=Tk()
root.title("intro")
con=sqlite3.Connection('flight_db')# CONNECTING DATABASE
cur=con.cursor()
...
Label(fr2,text="Presented By:-",font=("algerian",38),compound="center",fg="Orange").pack()
Label(fr2,text="Suryansh Shukla",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
